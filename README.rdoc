= README bud$et
Eine Mehrbenutzerapplikation zum Verwalten und Analysieren von Einnahmen und Ausgaben über die Zeit.
...
1 Basketnotiz nicht verfügbar ( Javascript on Ready Function zickt rum )
1 Design von Basket edit ( evlt für abgabe Notiz feld rauswerfen )
3 safe delete vom account und article model (wenn das sicher ist dass es uns nicht das ganze Projekt zerfetzt)
1 Nicht exitente Routen auf 404 leiten -> Routen anlegen
404 Page ansehbar ??
...
== Known Bugs
* Heroku --> assets werden nicht geladen (Javascript/CSS)
* Development --> Javascript wird erst nach einem Refresh der Seite geladen
